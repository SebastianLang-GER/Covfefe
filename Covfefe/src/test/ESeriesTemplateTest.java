...
public class ESeriesTemplateTest {
	public static void main(String[] args) {
		...
		System.out.println("Anzahl der Werte (Sollte 192 sein): " + E192.getItems());
		
		//Test der Methode getTolerance
		System.out.println("Rückgabe der Toleranz (Sollte 1 sein): " + E96.getTolerance());
		
		//Test der Methode getToleranceAsString
		System.out.println("Rückgabe der Toleranz (Sollte 1 % sein): " + E96.getToleranceAsString());
		
		//Test der Methode getValues
		System.out.println("Test mit E48:");
		double[] E48_test = E48.getValues();
		for (int i = 0; i < E48_soll.length; i++) {
			if (E48_soll[i] != E48_test[i]) {
				System.out.println("Da ist was falsch."); //Wenn keine Ausgabe, alles paletti
			}
		}
		...
		System.out.println("Name der E-Reihe (Sollte E12-Reihe sein): " + E12.getName());
		
		//Test der Methode toString in der Methode ESeriesTest
		
		//Test der Methoden getValue, calculateValues, roundToDecimals (Wenn nur Reihennamen ausgegeben, alles paletti)
		
		System.out.println("E3:");
		for (int i = 0; i < E3_soll.length; i++) {
			if (E3_soll[i] != E3.getValue(i)) {
				System.out.println("Ist: " + E3.getValue(i) + "; Soll: " + E3_soll[i]);
			}
		}
		...
		for (int i = 0; i < E6_soll.length; i++) {
			if (E6_soll[i] != E6.getValue(i)) {
				System.out.println("Ist: " + E6.getValue(i) + "; Soll: " + E6_soll[i]);
			}
		}
		...
		for (int i = 0; i < E12_soll.length; i++) {
			if (E12_soll[i] != E12.getValue(i)) {
				System.out.println("Ist: " + E12.getValue(i) + "; Soll: " + E12_soll[i]);
			}
		}
		...
		for (int i = 0; i < E24_soll.length; i++) {
			if (E24_soll[i] != E24.getValue(i)) {
				System.out.println("Ist: " + E24.getValue(i) + "; Soll: " + E24_soll[i]);
			}
		}
		...
		for (int i = 0; i < E48_soll.length; i++) {
			if (E48_soll[i] != E48.getValue(i)) {
				System.out.println("Ist: " + E48.getValue(i) + "; Soll: " + E48_soll[i]);
			}
		}
		...
		for (int i = 0; i < E96_soll.length; i++) {
			if (E96_soll[i] != E96.getValue(i)) {
				System.out.println("Ist: " + E96.getValue(i) + "; Soll: " + E96_soll[i]);
			}
		}
		...
		for (int i = 0; i < E192_soll.length; i++) {
			if (E192_soll[i] != E192.getValue(i)) {
				System.out.println("Ist: " + E192.getValue(i) + "; Soll: " + E192_soll[i]);
			}
		}
	}
}